...
with HospitalmanageTriageEnv(base_url="http://localhost:8001").sync() as env:
    ...
    # ### testing check reset state
    op = env.reset(patient_id='8118', tool_call_sequence=['get_department'])
    print(op.observation)
...
#     # output = env.reset(patient_id='8118', tool_call_sequence=['make_appointment'],output_sequence=['Appointment made successfully.'])
#     # doctor_id: int = 1234
#     # patient_id: int = 8118
