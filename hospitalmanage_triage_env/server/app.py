...
This module creates an HTTP server that exposes the HospitalmanageTriageEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m hospitalmanage_triage_env.server.app
    ...
    multiple workers:
        uvicorn hospitalmanage_triage_env.server.app:app --workers 4
    """
    import uvicorn
